...
export default () => {
	...
	const [psize, pattern] = PATTERN[randomInt(PATTERN.length)],
		color = [randomColor(125), randomColor(225)];
	if (Math.random() < .5) {
		color.reverse();
	}
	return [
