...
export default () => {
	...
	const [psize, pattern] = PATTERN[randomInt(PATTERN.length)],
		color = [randomColor(96), randomColor(220)];
	if (Math.random() < .5) {
		color.reverse();
	}
	return [
