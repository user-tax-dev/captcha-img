	...
	for (const i of svg.path) {
		path.push(
			`<path d="${i.d}" stroke="rgba(${randomInt(255)},${randomInt(
				255,
			)},${randomInt(255)},${randomInt(50) / 100})" stroke-width="${randomInt(
				2,
			)}px" fill="url(#bg${
				++n % 4
